  ...
  return (
    <Card>
      ...
      <h3>
        ...
        la autenticación de usuarios y operaciones CRUD (Crear, Leer, Actualizar, 
        Eliminar) tareas. Este proyecto versátil es ideal para una amplia gama de 
        aplicaciones, desde listas de tareas personales hasta aplicaciones de gestión 
        de proyectos.
      </h3>
    </Card>
  );
